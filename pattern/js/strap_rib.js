...
// piece information:
// width: 22 -> 20
// height: left 263 -> right 258
// # decreases: 2
// # rows per decrease: 4
// # shortrows: 1 pair (2 rows)
...
function decrease(width, offset, front, height) {
    ...
    for (var s=width-9; s<=width-offset; s++) {
        k.xfer("f" + s, "b" + s);
    }
    k.rack(-1);
    // and then decrease on 20
    for (var s=width-10; s<=width-offset-1; s++) {
        bn = s+1;
        k.xfer("b" + bn, "f" + s);
    }
    k.rack(0);
